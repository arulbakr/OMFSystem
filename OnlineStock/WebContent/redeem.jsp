...
<head>
	...
	<script type="text/javascript">
		...
		function checkform(){
			...
			if($("#Amount").val() === "" || ($("#Amount").val() <= 0 || $("#Amount").val() > 10000)){
				alert("Please enter some amount less than or equal to the existing balance or maximum of $10,000 or greater than zero.");
				return false;
			}
			return true;
		}
...
<div class="body">
	<div id="body" role="main" class="main margin-padding-top">
		<section style = "height : 620px;background-color:#F3F2F1;">
			<div class="container">
				<form action="./RedeemingServlet" method="post" name="transactionForm" onsubmit="return checkform()">
		            ...
		            <div class="row" style = "font-family: Helvetica, Arial, sans-serif;">
		                ...
		                <div class="col-md-8 push-bottom push-top" style = "font-family: Helvetica, Arial, sans-serif;" >
		                    <p><input type="submit" name="redeemFund" value="Redeem" class="btn btn-default" /></p>
		                </div>
		                <div class="col-md-2"></div>
		            </div>
	            </form>
